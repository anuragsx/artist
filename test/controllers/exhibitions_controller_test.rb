...
class ExhibitionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create exhibition" do
    assert_difference('Exhibition.count') do
      post exhibitions_url, params: { exhibition: { address: @exhibition.address, exhibition_by: @exhibition.exhibition_by, from_data: @exhibition.from_data, title: @exhibition.title, to_date: @exhibition.to_date } }
    end
  ...
  test "should update exhibition" do
    patch exhibition_url(@exhibition), params: { exhibition: { address: @exhibition.address, exhibition_by: @exhibition.exhibition_by, from_data: @exhibition.from_data, title: @exhibition.title, to_date: @exhibition.to_date } }
